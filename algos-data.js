	...
	var pll = [
		...
		},
		{
			...
			algs: [
				...
				{ type: "pll", moves: ["<bl>[Match F']</bl> LeftSlot [U2 R' F] R U LeftSlot U'", "[L U2' L' U2'] [L F'] [L' U' L U] [L F] L2' U"], name: "Ra", image_comment: "HL, I2B: 4 colors | O2B(adj), 3C: adj twice | 3C, 3C: BE adj twice | HL, 3C : checkers "},
